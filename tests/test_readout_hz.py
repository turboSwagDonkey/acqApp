"""
`presets.readout_hz` — the datasheet readout ceiling for an ROI.
...
USB3 rig was told it could do 115 Hz instead of 15.7.
...
table it claims to come from.
  ...
  acqApp\\.venv\\Scripts\\python.exe acqApp\\tests\\test_readout_hz.py
"""
