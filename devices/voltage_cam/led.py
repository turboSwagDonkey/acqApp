"""
Primary illumination LED controller — NI DAQ digital output.

Same shape as devices/pupil_cam/control.py's LedController, on a different
line: this rig's pupil-cam LED is Dev3/port0/line0, the puffer is line7, so
the primary LED is line2 — three DAQ tasks, none sharing a physical line.

LedController     : drives Dev3/port0/line2 (or any DO line) via nidaqmx.
